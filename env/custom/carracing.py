...
class CarRacing(gym.Wrapper):
    def __init__(self, frame_skip=0, frame_stack=4, should_reverse=False):
        self.env = gym.make("CarRacing-v1r", should_reverse=should_reverse)
    ...
    def to_action_space(self, original_action):
